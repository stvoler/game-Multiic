...
function Game() {
    ...
    Game.prototype.Init = function(mapId) {
        ...
        //$('#stats').html("");
        $('#menu').html("");
        $('#main').css({"background": "url('img/bg"+mapId+".png') no-repeat"});
        ...
        this.voxLoader.Add({file: "player_jump.vox", name: "player"});
        ...
        $('#statusCenter').html("<font size='20px' style='color: #FFFFFF; ' class=''>Loading...<br></font><font class='' style='font-size:20px; color: #FFFFFF;'>W-A-S-D-SPACE + 1 2 3 keys</font>");
        $('#statusCenter').show();
    ...
    Game.prototype.LoadScene = function(mapId) {
       ...
       // $('#status_4').text("Active triangles: "+this.chunkManager.activeTriangles);
        ...
        setTimeout(function() {
            ...
            //}
            game.setStatus("Kill all and save princess");
            $('#weapons').fadeIn(1000);
        }, 3000);
    ...
    Game.prototype.SetMap = function(id) {
        ...
        if(id == 1) {
            ...
            document.getElementById("song").src="sound/main1.mp3";
            map.mapId = 2;
            ...
            document.getElementById("song").src="sound/main3.mp3";
            map.mapId = 3;
            ...
            map.fogColor = 0x200e4a;
            map.clearColor = 0x200e4a;
            map.blockSize = 0.5;
            map.wallHeight = 20;
            map.useLava = false,
            map.useWater = false,
            map.useCoal = true;
            map.coalPosition = 0.2;
            map.waterPosition = 0;
            map.lavaPosition = 0;
            map.objects = function() {
            ...
            document.getElementById("song").src="sound/main.mp3";
            map.mapId = 4;
            ...
            map.fogColor = 0xb6e2f0;
            map.clearColor = 0xb6e2f0;
            map.blockSize = 0.5;
            map.wallHeight = 20;
            map.useLava = false,
            map.useWater = true;
