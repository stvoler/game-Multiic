...
function MapManager() {
    ...
    this.mapFile = "map5.png";
    this.startPosition = undefined; 
    this.playerModel = "player_run.vox";
    ...
    MapManager.prototype.BuildWorldChunks = function() {
        ...
        if(this.useCoal) {
            var coal = new Coal();
            coal.Create(game.scene); 
            game.objects.push(coal);
        }
        this.SpawnPlayer();
        $('#statusEnemies').fadeIn(600);
        $('#statusEnemies').text(" "+this.GetEnemiesLeft());
